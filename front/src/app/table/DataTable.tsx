                ...
                <div className="container-fluid pt-3">
                    <form onSubmit={props.handleSubmit} className="row gy-2 gx-3 align-items-center">
                        ...
                        <div className="col-auto">
                            ...
                            >
                                {props.isSubmitting ? <ButtonSpinner /> : "Išči"}
                            </button>
                        </div>
                    </form>
                </div>
        ...
        <div className="container-fluid pt-3">
            ...
            <div className="card shadow-lg rounded-0">
                <div className="card-header text-white bg-info rounded-0">
                    ...
                    {createItemLink && (
                        <Link to={createItemLink} className="btn btn-primary float-md-end rounded-0">Ustvari</Link>
                    )}
                        ...
                        <>
                            {data && data.length > 0 ?
                                <Table
                                    ...
                                    selection={selection}
                                />
                                : <h3 className="text-center">Ni rezultata</h3>
                            }
                        </>
                    )}
                </div>
